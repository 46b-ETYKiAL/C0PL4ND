...
mod app_report_ui;
mod app_search;
/// Forwarding a frame's keyboard/paste input to the FOCUSED pane's PTY through
/// the shared core key encoder — the "typing reaches the PTY" half of the
/// round-trip whose other half is `pane_body`.
mod input_forward;
